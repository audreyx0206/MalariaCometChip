...
%         startsearch = round(temp_htx*0.5); % *Lizzie* testing head-tail division %use this for 50um wafer with head diameter "21um"
...
%             % 2. Press "Control" + "R"
%             % To uncomment: Repeat step 1 and press "Control" + "t"  
% % % % %  
%                figure
%                subplot(2,1,1)
%                imshow(cometim)
